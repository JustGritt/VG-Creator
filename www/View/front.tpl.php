...
<body>
    ...
    <header class="flex">
        <a href="/front_website" class="left-items">
        ...
        <nav class="center-items flex">
            <ul class="flex">
                <li><a href="/front_website#templates" class="link">Nos projets</a></li>
                <li><a href="/front_website#faq" class="link">Qui sommes-nous ?</a></li>
                <li><a href="/front_website#footer" class="link">Nous contacter</a></li>
            </ul>
        </nav>
