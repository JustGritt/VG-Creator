        ...
        <tr>
          <td align="center">
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                  <a href="{{action_url}}" class="button button--" target="_blank">Confirm your mail</a>
                </td>
              </tr>
            </table>
          </td>
...
<p>If you have any questions, feel free to <a href="mailto:{{support_email}}">email our customer success team</a>. (We're lightning quick at replying.) 
<p>Thanks,
  <br>{{ sender_name }} and the {{ product_name }} Team</p>
<p><strong>P.S.</strong> Need immediate help getting started? Check out our github page<a href="{{help_url}}">help documentation</a>. Or, just reply to this email, the {{ product_name }} support team is always ready to help!</p>
<!-- Sub copy -->
